...
public class Hello_ServiceLocator extends org.apache.axis.client.Service implements mypackage.Hello_Service {
 ...
 */
    ...
    public mypackage.Hello_PortType getHello_Port() throws javax.xml.rpc.ServiceException {
    ...
    public mypackage.Hello_PortType getHello_Port(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            mypackage.Hello_BindingStub _stub = new mypackage.Hello_BindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (mypackage.Hello_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                mypackage.Hello_BindingStub _stub = new mypackage.Hello_BindingStub(new java.net.URL(Hello_Port_address), this);
                _stub.setPortName(getHello_PortWSDDServiceName());
                return _stub;
            }
        }
